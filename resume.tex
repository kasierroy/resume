...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{DB}{: SQL, Firebase} \\
     \textbf{Library}{: Boost, C++11/C++14/C++20} \\
     \textbf{OS}{: Linux, Windows} \\
     \textbf{Protocol}{: SNMP, NPAP} \\
     \textbf{Version Control}{: Git, Svn, Github, Gitlab, Gerrit, Jenkins} \\
